...
public abstract class AbstractPersistenceContext implements PersistenceContext {
    ...
    String resourcesURI = "/com/ogomonkey/db/support/mapping/*.hbm.xml";
    ...
    static Properties IPDEV_DEVO_CONNECTION_STRING = new Properties() {
        {
            ...
            setProperty("hibernate.connection.url", "localhost:8806/ofudii");
            setProperty("hibernate.connection.username", "monkey");
            setProperty("hibernate.connection.password", "ogo");
        }
    };
